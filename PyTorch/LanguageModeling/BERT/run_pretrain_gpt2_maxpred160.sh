...
seed=${12:-12439}
job_name=${13:-"wwmmlm_gpt2small_ss1024_maxpred160_300k_bs128_fp16"}
...
DATA_DIR_PHASE1=$CODEDIR/wikicorpus_data/wikibooks_wwm_ss1024_maxpred160/wikicorpus_books/
RESULTS_DIR="results"
